...
Percent change in encounters per FY nationally and by AOR. Note comparison between groups may be misleading because smaller population AORs will be more volatile.
...
p2 <- enc %>% 
  ...
  geom_col() +
  labs(title = "Total ICE encounters per month by operation, Biden admin.")
...
Overview of most common encounter `landmark` values gives a sense of the diversity of this category; note inclusion of general values likely denoting the ICE sub-office or divison responsible for the encounter rather than a precise location. Note also high proportion of records missing `landmark` values.
