...
Overview of most common arrest `apprehension_landmark` values gives a sense of the diversity of this category; note inclusion of general values likely denoting the ICE sub-office or divison responsible for the arrest rather than a precise location. Closer inspection is recommended at the AOR level.

`r length(unique(arr$apprehension_landmark))`
