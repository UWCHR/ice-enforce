...
Encounters: `r nrow(enc %>% filter(aor == specific_aor))`
Arrests: `r nrow(arr %>% filter(aor == specific_aor))`
Removals: `r nrow(rem %>% filter(aor == specific_aor))`

```{r load_supplemental_data, echo=FALSE, message=FALSE, warning=FALSE, include=TRUE}
...
```{r fy_total_plot, echo=FALSE, message=FALSE, include=TRUE}
