...
pd_dict <- read_yaml(here('share', 'hand', 'processing_disp.yaml'))
...
rem <- rem %>%
  mutate(year = year(departed_date),
         ...
         processing_disp = coalesce(processing_disposition_code, processing_disposition), # No correspondence of these two values
